...
public class CiftlikciKeremWatherCalculation{
    ...
    public static void printWholeInfo(double averageTenth, double averageEleventh, double differenceTenth, double differenceEleventh, double determineTenth, double determineEleventh, double largestDiffTenth, double largestDiffEleventh) {
        ...
        System.out.printf("Daily Tempeture difference of November 11th : %.2f°C\n", differenceEleventh);
        ...
        System.out.printf("The largest hourly temperature difference for November 10th: %.2f°C\n", largestDiffTenth);
        System.out.printf("The largest hourly temperature difference for November 11th: %.2f°C\n", largestDiffEleventh);
    }
    ...
    public static double findLargestHourlyDifference(double[] array) {
        double maxDifference = 0;

        for (int i = 1; i < array.length; i++) {
            double difference = array[i] - array[i - 1];
    ...
    public static void main(String[] args) {
        ...
        double largestDiffTenth = findLargestHourlyDifference(newTenthOfNovember);
        double largestDiffEleventh = findLargestHourlyDifference(newEleventhOfNovember);

        printWholeInfo(averageTenth, averageEleventh, differenceTenth, differenceEleventh, determineTenth, determineEleventh, largestDiffTenth, largestDiffEleventh);
    }
}
